        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    <a href="{{ route('structures.edit', $structure->ID) }}" class="btn btn-primary" style="background-color : black;">Modifier</a>
                    ...
                    <form action="{{ route('structures.destroy', $structure->ID) }}" method="POST" style="display: inline;">
                        @csrf
                      @method('DELETE')
                     <button type="submit" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette structure ?');" class="btn btn-danger" style="background-color: rgb(212, 205, 205); color: rgb(133, 16, 16);">Supprimer</button>
                    </form>
